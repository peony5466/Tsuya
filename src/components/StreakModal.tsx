...
const s = StyleSheet.create({
  ...
  dayToday: { borderWidth: 2, borderColor: "#60a5fa", backgroundColor: "#ffffff" },
  ...
  bubbleText: { fontSize: 14, color: "#1e293b", lineHeight: 21, fontWeight: "500" },
  ...
  backBtnText: { color: "#ffffff", fontSize: 17, fontWeight: "700" },
});
